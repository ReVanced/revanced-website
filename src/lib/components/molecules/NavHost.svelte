...
<nav class:scrolled={y > 10}>
	<div id="left-side">
		...
		<div class="nav-buttons">
			<Navigation  href="/"><span aria-label="Navigate to home">Home</span></Navigation>
			<Navigation href="/download"><span aria-label="Navigate to download section">Download</span></Navigation>
			<Navigation href="/patches"><span aria-label="Navigate to patches">Patches</span></Navigation>
			<div hidden>
			...
			<Navigation href="/contributors"><span aria-label="Navigate to contributors">Contributors</span></Navigation>
		</div>
	</div>
	<div id="right-side">
		<button aria-label="Open settings" on:click={() => (modalOpen = !modalOpen)}>
	...
	<div class="settings-menu">
		...
		<div id="content">
			<div class="input-wrapper">
				...
				<button aria-label="reset button" class="button-reset" on:click={reset}>
			...
			<div class="buttons">
				<Button kind="primary" on:click={save}><span aria-label="save button">Save</span></Button>
				<Button on:click={clear_and_reload}><span aria-label="clear and reload cache button">Clear Cache</span></Button>
			</div>
		</div>
	</div>
</Modal>
